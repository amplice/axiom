...
pub fn docs_endpoints() -> Vec<serde_json::Value> {
    vec![
        ...
        serde_json::json!({"method":"GET","path":"/diagnose","description":"Diagnose entities with missing companion components. Returns issues for entities that have components which can't function (e.g. ContactDamage without Collider)","categories":["core","testing"]}),
        // Window config
...
pub fn docs_components() -> Vec<serde_json::Value> {
    vec![
        serde_json::json!({"name":"collider","fields":{"width":"f32","height":"f32"},"systems":["contact_damage","pickup","hitbox(target)","projectile(target)","entity_collision","horizontal_movement","jump","check_grounded"],"requires":[],"optional":["collision_layer","solid_body"]}),
        serde_json::json!({"name":"circle_collider","fields":{"radius":"f32"},"systems":["contact_damage","pickup","hitbox(target)","projectile(target)","entity_collision"],"requires":[],"optional":["collision_layer","solid_body"]}),
        serde_json::json!({"name":"gravity_body","fields":{},"systems":["apply_gravity"],"requires":[],"optional":[]}),
        serde_json::json!({"name":"horizontal_mover","fields":{"speed":"f32","left_action":"string","right_action":"string"},"systems":["horizontal_movement"],"requires":["collider"],"optional":[]}),
        serde_json::json!({"name":"jumper","fields":{"velocity":"f32","action":"string","fall_multiplier":"f32","variable_height":"bool","coyote_frames":"u32","buffer_frames":"u32"},"systems":["jump_system"],"requires":["gravity_body","collider"],"optional":[]}),
        serde_json::json!({"name":"top_down_mover","fields":{"speed":"f32","up_action":"string","down_action":"string","left_action":"string","right_action":"string"},"systems":["top_down_movement"],"requires":["collider"],"optional":[]}),
        serde_json::json!({"name":"health","fields":{"current":"f32","max":"f32"},"systems":["death_system","(target for damage systems)"],"requires":[],"optional":["collider","circle_collider"]}),
        serde_json::json!({"name":"contact_damage","fields":{"amount":"f32","cooldown_frames":"u32","knockback":"f32","damage_tag":"string"},"systems":["contact_damage_system"],"requires":["collider OR circle_collider"],"optional":["collision_layer"]}),
        serde_json::json!({"name":"trigger_zone","fields":{"radius":"f32","trigger_tag":"string","event_name":"string","one_shot":"bool"},"systems":["trigger_zone_system"],"requires":[],"optional":[]}),
        serde_json::json!({"name":"pickup","fields":{"pickup_tag":"string","effect":"{type: heal|score_add|custom, ...}"},"systems":["pickup_system"],"requires":["collider OR circle_collider"],"optional":["collision_layer"]}),
        serde_json::json!({"name":"projectile","fields":{"speed":"f32","direction":"{x,y}","lifetime_frames":"u32","damage":"f32","owner_id":"u64","damage_tag":"string"},"systems":["projectile_system"],"requires":[],"optional":["collider","circle_collider"]}),
        serde_json::json!({"name":"hitbox","fields":{"width":"f32","height":"f32","offset":"{x,y}","active":"bool","damage":"f32","damage_tag":"string"},"systems":["hitbox_system"],"requires":[],"optional":["collision_layer"]}),
        serde_json::json!({"name":"moving_platform","fields":{"waypoints":"[{x,y},...]","speed":"f32","loop_mode":"loop|ping_pong","pause_frames":"u32","carry_riders":"bool","current_waypoint":"usize","direction":"i8"},"systems":["moving_platform_system"],"requires":[],"optional":["collider"]}),
        serde_json::json!({"name":"animation_controller","fields":{"graph":"string","state":"string","frame":"usize","timer":"f32","speed":"f32","playing":"bool","facing_right":"bool","auto_from_velocity":"bool"},"systems":["animation_system"],"requires":[],"optional":[]}),
        serde_json::json!({"name":"particle_emitter","fields":{"preset":"string?","emit_rate":"f32","lifetime":"f32","spread_angle":"f32","speed_min":"f32","speed_max":"f32","one_shot":"bool","burst_count":"u32"},"systems":["particle_system"],"requires":[],"optional":[]}),
        serde_json::json!({"name":"path_follower","fields":{"target":"{x,y}","recalculate_interval":"u32","path_type":"top_down|platformer","speed":"f32"},"systems":["path_follower_system"],"requires":[],"optional":["collider"]}),
        serde_json::json!({"name":"ai_behavior","fields":{"behavior":"{type: patrol|chase|flee|guard|wander|custom, ...}"},"systems":["ai_system"],"requires":[],"optional":["collider","path_follower"]}),
        serde_json::json!({"name":"collision_layer","fields":{"layer":"u16 (bitmask)","mask":"u16 (bitmask)"},"systems":["(passive, queried by interaction systems)"],"requires":["collider OR circle_collider"],"optional":[]}),
        serde_json::json!({"name":"solid_body","fields":{},"systems":["entity_collision_system"],"requires":["collider OR circle_collider"],"optional":["collision_layer"]}),
        serde_json::json!({"name":"sprite_color_tint","fields":{"color":"[f32;4] RGBA","flash_color":"[f32;4]?","flash_frames":"u32"},"systems":["tint_system"],"requires":[],"optional":[]}),
        serde_json::json!({"name":"trail_effect","fields":{"interval":"u32 (frames between ghosts)","duration":"f32 (ghost lifetime)","alpha_start":"f32","alpha_end":"f32"},"systems":["trail_system"],"requires":[],"optional":[]}),
        serde_json::json!({"name":"state_machine","fields":{"initial":"string","states":"{ name: { allowed_transitions, on_enter_event?, on_exit_event? } }"},"systems":["state_machine_system"],"requires":[],"optional":[]}),
        serde_json::json!({"name":"inventory","fields":{"max_slots":"usize"},"systems":["(passive)"],"requires":[],"optional":[]}),
        serde_json::json!({"name":"invisible","fields":{},"systems":["render_system(skip)"],"requires":[],"optional":[]}),
        serde_json::json!({"name":"render_layer","fields":{"layer":"i32"},"systems":["render_system"],"requires":[],"optional":[]}),
        serde_json::json!({"name":"point_light","fields":{"radius":"f32","intensity":"f32","color":"[f32;3]"},"systems":["lighting_system"],"requires":[],"optional":[]}),
        serde_json::json!({"name":"velocity_damping","fields":{"factor":"f32"},"systems":["apply_drag"],"requires":[],"optional":[]}),
        serde_json::json!({"name":"knockback_impulse","fields":{"vx":"f32","vy":"f32"},"systems":["apply_knockback_impulse"],"requires":[],"optional":[]}),
    ]
}
